  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {/* Meals Served */}
        <div className="rounded-3xl bg-white p-6 shadow-sm border border-border/40 transition-all hover:shadow-md hover:border-primary/20">
          <div className="flex justify-between items-start mb-4">
            <div className="p-3 rounded-2xl bg-muted/30 text-primary border border-border/50">
              <Utensils className="h-5 w-5" />
            </div>
            <span className="flex items-center text-[11px] font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-100">
              <TrendingUp className="mr-1 h-3 w-3" />
              +12%
            </span>
          </div>
          <div>
            <div className="text-2xl font-bold text-foreground tracking-tight">{mealsServed.toLocaleString()}</div>
            <div className="text-[9px] font-semibold text-muted-foreground uppercase tracking-widest mt-1">Meals Served Today</div>
          </div>
        </div>

        {/* Current Waiting */}
        <div className="rounded-3xl bg-white p-6 shadow-sm border border-border/40 transition-all hover:shadow-md hover:border-amber-500/20">
          <div className="flex justify-between items-start mb-4">
            <div className="p-3 rounded-2xl bg-amber-50 text-amber-600 border border-amber-100/50">
              <Users className="h-5 w-5" />
            </div>
            <span className="flex items-center text-[11px] font-bold text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full border border-amber-100">
              ~24 mins
            </span>
          </div>
          <div>
            <div className="text-2xl font-bold text-foreground tracking-tight">{waitingCrowd}</div>
            <div className="text-[9px] font-semibold text-muted-foreground uppercase tracking-widest mt-1">Queue Waiting</div>
          </div>
        </div>

        {/* Kitchen Status */}
        <div className="rounded-3xl bg-white p-6 shadow-sm border border-border/40 transition-all hover:shadow-md hover:border-orange-500/20">
          <div className="flex justify-between items-start mb-4">
            <div className="p-3 rounded-2xl bg-orange-50 text-orange-600 border border-orange-100/50">
              <Flame className="h-5 w-5" />
            </div>
            <span className="flex items-center text-[11px] font-bold text-orange-600 bg-orange-50 px-2 py-0.5 rounded-full border border-orange-100">
              <span className="h-1.5 w-1.5 rounded-full bg-orange-500 mr-1.5 animate-pulse" />
              Live
            </span>
          </div>
          <div>
            <div className="text-xl font-bold text-foreground tracking-tight mt-1">Cooking Dinner</div>
            <div className="text-[9px] font-semibold text-muted-foreground uppercase tracking-widest mt-1.5">Kitchen Status</div>
          </div>
        </div>

        {/* Volunteers */}
        <div className="rounded-3xl bg-white p-6 shadow-sm border border-border/40 transition-all hover:shadow-md hover:border-indigo-500/20">
          <div className="flex justify-between items-start mb-4">
            <div className="p-3 rounded-2xl bg-indigo-50 text-indigo-600 border border-indigo-100/50">
              <HeartHandshake className="h-5 w-5" />
            </div>
            <span className="flex items-center text-[11px] font-bold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-full border border-indigo-100">
              Serving Now
            </span>
          </div>
          <div>
            <div className="text-2xl font-bold text-foreground tracking-tight">{12 * capacityMultiplier}</div>
            <div className="text-[9px] font-semibold text-muted-foreground uppercase tracking-widest mt-1">On-Duty Volunteers</div>
          </div>
        </div>
      </div>
          ...
          <div className="overflow-hidden rounded-3xl bg-white shadow-sm border border-border/40">
            ...
            <div className="p-6 grid gap-6 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-border/50 bg-white p-5 transition-shadow hover:shadow-sm">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h4 className="text-sm font-bold text-foreground">Hall B (Families)</h4>
