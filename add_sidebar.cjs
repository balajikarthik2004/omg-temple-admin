...
const file = 'c:\\Users\\KaviyapriyaPerumal\\Desktop\\omg-temple-admin\\omg-temple-admin\\src\\components\\temple\\TempleShell.tsx';
...
content = content.replace(
  /<div className="min-w-0 flex-1 text-left">\s*<div className="truncate text-sm font-medium text-sidebar-foreground">\s*Rajesh Kumar\s*<\/div>\s*<div className="truncate text-\[10px\] uppercase tracking-wider text-sidebar-muted">\s*Executive Officer\s*<\/div>\s*<\/div>/,
  '{sidebarExpanded && <div className="min-w-0 flex-1 text-left"><div className="truncate text-sm font-medium text-sidebar-foreground">Rajesh Kumar</div><div className="truncate text-[10px] uppercase tracking-wider text-sidebar-muted">Executive Officer</div></div>}'
);
content = content.replace(
